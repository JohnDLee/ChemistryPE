...
# Last Modified: Thursday, 27th July 2023 9:51:39 am
...
"""
    ...
    for idx, e in enumerate(examples):
        ...
        for iidx, intermediate in enumerate(e.intermediates[2:], start=2): # skip first, cause always the same
            ...
            prompt += f"Intermediate {path_idx + 1}: {reasoning} The resulting intermediate is {intermediate}\n"
        prompt += f"Products: The final intermediate is sanitized and the SMILES string is canonized. The final answer is {e.broken_down_parts.products}\n"
