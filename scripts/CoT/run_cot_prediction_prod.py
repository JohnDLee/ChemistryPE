...
# Last Modified: Monday, 24th July 2023 1:21:47 pm
...
if __name__ == '__main__':
    ...
    # storage dir 
    results_dir = Path(os.environ['RESULTS_DIR']) / "cot_prediction_product" / model.value
    ...
    np.save(str(results_dir / "cot_prediction_product_results.npy"), dict(info), allow_pickle=True)
