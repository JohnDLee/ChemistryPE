...
# Last Modified: Wednesday, 12th July 2023 12:18:39 am
...
if __name__ == '__main__':
    ...
    # storage dir 
    results_dir = Path(os.environ['RESULTS_DIR']) / "step2_prediction" / model.value
    ...
    np.save(str(results_dir / "step2_prediction_results.npy"), dict(info), allow_pickle=True)
