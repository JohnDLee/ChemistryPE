...
# Last Modified: Friday, 21st July 2023 2:00:47 pm
...
if __name__ == '__main__':
    ...
    # storage dir 
    results_dir = Path(os.environ['RESULTS_DIR']) / "few_shot_specific" / model.value
    ...
    np.save(str(results_dir / "few_shot_specific_results.npy"), dict(info), allow_pickle=True)
