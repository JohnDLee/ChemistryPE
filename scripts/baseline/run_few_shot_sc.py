...
# Last Modified: Wednesday, 5th July 2023 7:09:31 pm
...
if __name__ == '__main__':
    ...
    # storage dir 
    results_dir = Path(os.environ['RESULTS_DIR']) / "few_shot_sc" / model.value
    ...
    np.save(str(results_dir / "few_shot_sc_results.npy"), dict(info), allow_pickle=True)
